...
public class ElleHacksApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    this.scenarioRepository.save(new Scenario(
        "Your mother advises you to save 25% of your income every year for the rest of your life.",
        16, "Yeah okay, that sounds like a great idea.", 0, 0, 0,
        "No, I'd rather spend my money and have fun.", -10, 0, 0));
    this.scenarioRepository.save(new Scenario(
    ...
    this.scenarioRepository.save(new Scenario(
        ...
        19, "Yes, I will go to university.", 0, 0, 9000, "No, I do not want to go to university.",
        0, 0, 0));
    this.scenarioRepository.save(new Scenario(
        ...
        "Oh yeah! I'll use that money on a luxurious shopping spree at the mall!", 0, 0, 0));
    this.scenarioRepository.save(new Scenario(
    ...
    this.scenarioRepository.save(new Scenario(
        ...
        24, "I will purchase a gaudy $200 necklace for my mother. She deserves the best!", -200, 0,
        0, "I will wish my mother a happy birthday, knowing my presence is already a gift to her.",
        0, 0, 0));
    this.scenarioRepository.save(new Scenario(

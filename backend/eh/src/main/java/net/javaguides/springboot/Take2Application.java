...
public class Take2Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
	  ...
	  this.scenarioRepository.save(new Scenario("Your friends want you to buy them ice cream. It will cost you 10$ at McDonald's.", "Yes, buy the icecream", -10, 0, "No, save my money", 0, 0)); 
	}

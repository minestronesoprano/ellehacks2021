...
public class ElleHacksApplication implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    this.scenarioRepository.save(new Scenario(
        ...
        0, 0, 0));
    this.scenarioRepository.save(new Scenario(
        "Congratulations! You graduated and are currently deciding between 2 job offers: Job A pays $75k yearly and is conveniently near your area! Job B pays"
            + " $100k yearly but the office is located in a completely different province and will require you to move.",
